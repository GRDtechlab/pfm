    ...
    return (
        <>
                <div className= { props.open ? ['sidebar shadow','sidebar-show',' container'].join(' ') : ['sidebar shadow','container'].join(' ')}>
                    ...
                    <div className="menu">
                    <NavLink onClick={() => props.setOpen(false)} to='/' className={({isActive})=>(isActive ? 'active-link' : '')}> 
                        ...
                        <Submenu title="Reports" headicon={<i className="bi bi-graph-up"></i>} submenu_item={[
